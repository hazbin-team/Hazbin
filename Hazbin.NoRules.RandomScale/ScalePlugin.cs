...
public class ScalePlugin : Plugin {
    public override string Name => "RandomScale";
    public override string Description => "Rp elements on norules, made specially for Hazbin";
